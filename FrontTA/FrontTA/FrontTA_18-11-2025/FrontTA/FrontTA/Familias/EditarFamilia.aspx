<%@ Page Title="" Language="C#" MasterPageFile="~/SoftProg.Master" AutoEventWireup="true"
    CodeBehind="EditarFamilia.aspx.cs" Inherits="FrontTA.Familias.EditarFamilia" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_Title" runat="server">
    Colegio Rafael Mariscal Quintanilla - Editar Familia
</asp:Content>
    ...
    <div class="container-fluid familias-container">
        ...
        <div class="toolbar mb-3">
            <div class="icon-bar">
                ...
                <button type="button" class="btn-icon btn-active" title="Editar familia">
                    <i class="fa-solid fa-pen"></i>
                </button>
                <!-- resto de botones en gris -->
            ...
            <span class="header-cta">Editar Familia</span>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="fieldset">
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            ...
                            <div class="col-7">
                                <asp:TextBox ID="txtApePaterno" runat="server" CssClass="form-control" MaxLength="60"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            ...
                            <div class="col-7">
                                <asp:TextBox ID="txtApeMaterno" runat="server" CssClass="form-control" MaxLength="60"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            ...
                            <div class="col-7">
                                <asp:TextBox ID="txtCorreo" runat="server" CssClass="form-control" MaxLength="120"></asp:TextBox>
                            </div>
                        </div>
