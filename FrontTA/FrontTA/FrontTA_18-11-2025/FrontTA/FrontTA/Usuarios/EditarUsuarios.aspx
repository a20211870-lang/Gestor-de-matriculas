<%@ Page Title="" Language="C#" MasterPageFile="~/SoftProg.Master" AutoEventWireup="true"
    CodeBehind="EditarUsuarios.aspx.cs" Inherits="FrontTA.Usuarios.EditarUsuarios" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_Title" runat="server">
    Colegio Rafael Mariscal Quintanilla - Editar Usuario
</asp:Content>
    ...
    <div class="container-fluid familias-container">
        ...
        <div class="toolbar mb-3">
            <div class="icon-bar">
                ...
                <button type="button" class="btn-icon btn-active" title="Editar usuario">
            ...
            <span class="header-cta">Editar Usuario</span>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="fieldset">
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            ...
                            <div class="col-7">
                                <asp:TextBox ID="txtClave" runat="server" CssClass="form-control" TextMode="Password" MaxLength="64"></asp:TextBox>
                            </div>
                        </div>
