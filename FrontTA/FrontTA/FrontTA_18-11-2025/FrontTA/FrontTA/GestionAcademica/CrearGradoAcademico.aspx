<%@ Page Title="" Language="C#" MasterPageFile="~/SoftProg.Master" AutoEventWireup="true"
    CodeBehind="CrearGradoAcademico.aspx.cs"
    Inherits="FrontTA.GestionAcademica.CrearGradoAcademico" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_Title" runat="server">
    Colegio Rafael Mariscal Quintanilla - Crear Grado Académico
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_Contenido" runat="server">
    <div class="container-fluid familias-container">
        ...
        <div class="toolbar mb-3">
            <div class="icon-bar">
                <!-- Crear (activo) -->
                <button type="button" class="btn-icon btn-active" title="Crear grado académico">
            ...
            <span class="header-cta">Crear Grado Académico</span>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="fieldset">
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-5 text-end"><label class="form-label">Activo:</label></div>
                            <div class="col-7">
