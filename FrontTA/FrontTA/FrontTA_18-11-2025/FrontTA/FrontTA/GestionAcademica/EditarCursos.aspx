<%@ Page Title="" Language="C#" MasterPageFile="~/SoftProg.Master" AutoEventWireup="true" CodeBehind="EditarCursos.aspx.cs" Inherits="FrontTA.GestionAcademica.EditarCursos" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_Title" runat="server">
    Colegio Rafael Mariscal Quintanilla - Editar Grado Académico
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Scripts" runat="server">
    <style>
        ...
        .btn-accept,.btn-cancel{
            ...
            width:56px; height:56px; border-radius:12px; border:2px solid #00000030;
            display:inline-flex; align-items:center; justify-content:center;
            font-size:1.6rem; cursor:pointer; background:#fff;
    ...
    <div class="container-fluid familias-container">
        ...
        <div class="toolbar mb-3">
            <div class="icon-bar">
                ...
                <button type="button" class="btn-icon btn-active" title="Editar curso">
                    <i class="fa-solid fa-pen"></i>
                </button>
                <!-- resto en gris / bloqueados -->
                <button type="button" class="btn-icon btn-muted" title="Añadir" disabled>
                    <i class="fa-solid fa-book-open"></i>
                </button>
                <button type="button" class="btn-icon btn-muted" title="Consultar" disabled>
            ...
            <span class="header-cta">Editar Curso</span>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="fieldset">
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-5 text-end">
                                <label class="form-label" for="ddlGrado">GradoAcademico:</label>
                            </div>
                            <div class="col-7">
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end">
                                <label class="form-label" for="txtAbrev">Abreviatura:</label>
                            </div>
                            <div class="col-7">
                                <asp:TextBox ID="txtAbreviatura" runat="server" CssClass="form-control" MaxLength="20"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end">
                                <label class="form-label" for="txtHoras">Horas Semanales:</label>
                            </div>
                            <div class="col-7">
                                <asp:TextBox ID="txtHoras" runat="server" CssClass="form-control" MaxLength="20"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end">
                            ...
                            <div class="col-7">
                                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control" MaxLength="40"></asp:TextBox>
                            </div>
                        </div>
                    ...
                    <div class="action-buttons mt-3">
                        <!-- ✔ guardar cambios -->
                        <asp:LinkButton ID="btnConfirmar" runat="server" CssClass="btn-accept" OnClick="btnConfirmar_Click" ToolTip="Guardar">
