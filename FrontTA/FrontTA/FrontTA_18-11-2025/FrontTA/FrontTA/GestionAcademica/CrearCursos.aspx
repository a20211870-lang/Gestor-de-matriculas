<%@ Page Title="" Language="C#" MasterPageFile="~/SoftProg.Master" AutoEventWireup="true" CodeBehind="CrearCursos.aspx.cs" Inherits="FrontTA.GestionAcademica.CrearCursos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph_Title" runat="server">
    Colegio Rafael Mariscal Quintanilla - Crear Curso
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Scripts" runat="server">
    <style>
        ...
        .btn-accept,.btn-cancel{
            ...
            width:64px; height:64px; border-radius:12px; border:2px solid #00000030;
        ...
        @media (max-width: 991.98px){ .side-panel{ margin-top:1rem; } }
    </style>
        <script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_Contenido" runat="server">
    <div class="container-fluid familias-container">
        ...
        <div class="toolbar mb-3">
            <div class="icon-bar">
                <!-- Crear (activo) -->
                <button type="button" class="btn-icon btn-active" title="Crear Curso">
            ...
            <span class="header-cta">Crear Curso</span>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    <div class="fieldset">
                        ...
                        <!-- Activo (bloqueado mostrando Vigente) -->
                    ...
                    <div class="action-buttons mt-3">
                        <asp:LinkButton ID="btnConfirmar" runat="server" CssClass="btn-accept"
                            OnClick="btnConfirmar_Click" ToolTip="Crear">
