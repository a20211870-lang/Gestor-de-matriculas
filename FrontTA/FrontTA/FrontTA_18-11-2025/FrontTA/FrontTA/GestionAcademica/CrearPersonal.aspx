<%@ Page Title="" Language="C#" MasterPageFile="~/SoftProg.Master" AutoEventWireup="true"
    CodeBehind="CrearPersonal.aspx.cs" Inherits="FrontTA.GestionAcademica.CrearPersonal" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_Title" runat="server">
    Colegio Rafael Mariscal Quintanilla - Crear Personal
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Scripts" runat="server">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const btnClose = document.getElementById('btnCloseHistorial');
            ...
            // --- Seleccionar cargo desde GridView ---
            ...
            // --- Actualizar visibilidad dinámica ---
            ...
            function seleccionarCargo(cargoId, cargoNombre) {
                document.getElementById('<%= hfCargoId.ClientID %>').value = cargoId;
            }
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_Contenido" runat="server">
    ...
    <div class="container-fluid familias-container">
        ...
        <div class="toolbar mb-3">
            <div class="icon-bar">
                <!-- “Crear Personal” ACTIVO (celeste) -->
                <button type="button" class="btn-icon btn-active" title="Crear personal">
            ...
            <span class="header-cta">Crear Personal</span>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    <div class="fieldset">
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end">
                                <label class="form-label2">Cargo:</label>
                            </div>
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-5 text-end">
                                <label class="form-label2">Tipo Contrato:</label>
                            </div>
                            <div class="col-7">
