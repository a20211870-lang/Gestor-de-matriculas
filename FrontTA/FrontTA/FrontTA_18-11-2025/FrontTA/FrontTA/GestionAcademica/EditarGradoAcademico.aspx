<%@ Page Title="" Language="C#" MasterPageFile="~/SoftProg.Master" AutoEventWireup="true"
    CodeBehind="EditarGradoAcademico.aspx.cs"
    Inherits="FrontTA.GestionAcademica.EditarGradoAcademico" %>
    ...
    <div class="container-fluid familias-container">
        ...
        <div class="toolbar mb-3">
            <div class="icon-bar">
                ...
                <button type="button" class="btn-icon btn-active" title="Editar grado">
            ...
            <span class="header-cta">Editar Grado Académico</span>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="fieldset">
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            ...
                            <div class="col-7">
                                <asp:TextBox ID="txtAbrev" runat="server" CssClass="form-control" MaxLength="20"></asp:TextBox>
                            </div>
                        </div>

                        <div class="row g-3 align-items-center">
                            <div class="col-5 text-end">
                                <label class="form-label" for="ddlActivo">Activo:</label>
                            </div>
                            <div class="col-7">
