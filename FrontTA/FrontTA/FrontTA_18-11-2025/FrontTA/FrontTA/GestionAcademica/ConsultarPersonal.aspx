<%@ Page Title="" Language="C#" MasterPageFile="~/SoftProg.Master" AutoEventWireup="true"
    CodeBehind="ConsultarPersonal.aspx.cs" Inherits="FrontTA.GestionAcademica.ConsultarPersonal" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_Title" runat="server">
    Colegio Rafael Mariscal Quintanilla - Consultar Personal
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_Contenido" runat="server">
    <div class="container-fluid familias-container">
        ...
        <div class="toolbar mb-3">
            <div class="icon-bar">
                <!-- lupa ACTIVA (celeste) -->
                <button type="button" class="btn-icon btn-active" title="Consultar personal">
                ...
                <button type="button" class="btn-icon btn-muted" title="Editar personal" disabled>
            ...
            <span class="header-cta">Consultar Personal</span>
        </div>
                    ...
                    <div class="fieldset">
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end">
                                <label class="form-label">DNI:</label></div>
                            <div class="col-7">
                                <asp:TextBox ID="txtDni" runat="server" CssClass="form-control input-disabled" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>

                        <!-- Cargos -->
                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end"><label class="form-label">Cargo:</label></div>
                            <div class="col-4 text-end">
                                <asp:TextBox ID="txtCargo" runat="server" CssClass="form-control input-disabled" ReadOnly="true"></asp:TextBox>
                                <asp:HiddenField ID="hfCargoId" runat="server" />
                            </div>
                        </div>

                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end"><label class="form-label">Num Telf:</label></div>
                            <div class="col-7">
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end"><label class="form-label">Email:</label></div>
                            <div class="col-7">
                                <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control input-disabled" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>

                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end"><label class="form-label">Sueldo:</label></div>
                            <div class="col-7">
                                <asp:TextBox ID="txtSueldo" runat="server" CssClass="form-control input-disabled" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>

                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end"><label class="form-label">Fecha Inicio Contrato:</label></div>
                            <div class="col-7">
                                <asp:TextBox ID="txtFechaInicio" runat="server" CssClass="form-control input-disabled" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>

                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end"><label class="form-label">Fecha Fin Contrato:</label></div>
                            <div class="col-7">
                                <asp:TextBox ID="txtFechaFin" runat="server" CssClass="form-control input-disabled" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>

                        <div class="row g-3 align-items-center">
                            <div class="col-5 text-end"><label class="form-label">Tipo Contrato:</label></div>
                            <div class="col-7">
                                <asp:TextBox ID="txtTipoContrato" runat="server" CssClass="form-control input-disabled" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>
